    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>          
          ...
          <li class="dropdown "><a href="#"><span>Carteira</span><i class="dropdown-toggle dropdown-indicator"></i></a>
            <ul>
              <li>Valor Recebido</li>
              <li>R$ <?php echo $soma_precos;?></li>
            </ul>
          </li>
          ...
          <li><a href="<?php echo base_url('index.php/home/saircontas') ?> ">Sair</a></li>
          </u>
      </nav><!-- .navbar -->
