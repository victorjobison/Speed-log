...
<head>
  ...
  <title>Speed Log - Cadastro Parceiro</title>
      ...
      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="card mb-3" style="">
          ...
          <div class="card-body">
            ...
            <div class="existe" id="existe">Dados existentes!</div>
            <form id="form-cadastro" action="<?php echo base_url('index.php/home/add_parceiro')?>" method="post" class="row g-3 needs-validation"  enctype="multipart/form-data" novalidate>
                <div class="col-12">
                ...
                <div class="col-12">
                    <label for="yourPlaca" class="form-label">Placa da Moto</label>
                    <input type="text" name="placa" class="form-control" id="placa" required>
                    <div class="invalid-feedback">Por favor, insira um cpf valido!</div>
                </div>

                <div class="col-12">
                    <label for="yourUsername" class="form-label">Numero de Telefone</label>
                    <div class="input-group has-validation">
                    <input type="text" name="telefone" class="form-control" id="telefone" required>
                    <div class="invalid-feedback">Por favor, insira um numero de telefone válido!</div>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <label for="imagem">Foto do rosto (3x4)</label>
                    <input type="file" name="imagem" id="imagem">
                    <div class="invalid-feedback">Por favor, insira uma foto do rosto (3x4)!</div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-primary w-100" id="show-or-ride" type="submit">Criar uma conta</button>
                </div>
            </form>
          </div>
        </div>
...
<!-- Vendor JS Files -->
  <script>
    ...
    var placaMask = IMask(document.getElementById('placa'), {
      mask: 'SSS - 0000',
      blocks: {
        S: {
          mask: /^[a-zA-Z]{1}$/ // Apenas uma letra
        },
        0: {
          mask: /^[0-9]{1}$/ // Apenas um número
        }
      }
    });
  </script>
