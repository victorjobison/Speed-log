                ...
                <div class="row gy-4"> <?php
                    ...
                    <div class="col">
                        <div class="card" style="width: 23rem;height: 25rem;">            
                            <div class="card-body">
                                <h5> Olá <?php echo $entrega->nome_cliente?>, seu pedido está a caminho!</h5>
                                <div style="display: flex; align-items: center; width: 100%; border-top: 1px solid #000; padding: 10px; ">
                                    <img src="<?php echo base_url('assets/img/'.str_replace(".", "_", $entrega->usuario_parceiro).'.jpeg'); ?>" alt="" style="width: 25%; border-radius: 50%; margin-right: 5%">
                                    <h5><?php echo $entrega->nome_parceiro?> </h5>
                                </div> 
