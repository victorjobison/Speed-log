...
<head>
  ...
  <title>Speed Log - Login Cliente</title>
      ...
      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="<?php echo base_url('index.php/Home/autenticar_cliente')?>" method="post" class="row g-3 needs-validation" novalidate>
              ...
              <div class="col-12">
                <p class="small mb-0">Não tem uma conta? <a href="<?php echo base_url('index.php/home/cadastro_cliente')?>">Crie sua conta aqui</a></p>
              </div>
            </form>
