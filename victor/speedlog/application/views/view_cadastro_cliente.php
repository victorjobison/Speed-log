...
<head>
  ...
  <title>Speed Log - Cadastro Cliente</title>
  <meta content="" name="description">
  <meta content="" name="keywords">
  

  <!-- Favicons -->
  <link href="assets/img/cliente3.png" rel="icon">
      ...
      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-center py-4">
          <a href="<?php echo base_url() ?>" class="logo d-flex align-items-center w-auto">
            <img src="<?php echo base_url('assets/img/cliente3.png') ?>" alt="">
            <span class="d-none d-lg-block" style="color: #a5b5d1;;">SpeedLog Cliente</span>
          </a>
        </div><!-- End Logo -->
        ...
        <div class="card mb-3" style="">
          ...
          <div class="card-body">
            ...
            <form action="<?php echo base_url('index.php/home/add_cliente') ?>" method="post" class="row g-3 needs-validation" novalidate>
                <div class="col-12">
                ...
                <div class="col-12">
                    <label for="yourEndereco" class="form-label">Cpf</label>
                    <input type="text" name="cpf" class="form-control" id="cpf" required>
                    <div class="invalid-feedback">Por favor, insira seu Cpf!</div>
                </div>
                <div class="col-12">
                    <label for="yourEndereco" class="form-label">Cep</label>
                    <input type="text" name="cep" class="form-control" id="cep" required>
                    <div class="invalid-feedback">Por favor, insira se Cep!</div>
                </div>
                <div class="col-12">
                    <label for="yourEndereco" class="form-label">email</label>
...
<script>
  ...
  mask: /^[a-zA-ZÀ-ÿ\s]+$/ // Apenas letras, espaços em branco e acentos
   ...
   var cepMask = IMask(document.getElementById('cep'), {
      mask: '00000-000'
    });
