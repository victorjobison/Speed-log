            ...
            <div class="rolag" id="">
              <div class="row gy-4"> 
                <?php foreach($dados as $dados=>$entrega){?>
                  <div class="col">
                    <div class="card text-center mb-3"style="width: 20rem; height: 24rem;opacity: 0.9; background-color: white !important">
                      <div class="card-body">
                        <h5><?php echo $entrega->nome_cliente?>, seu pedido foi entregue!</h5>
