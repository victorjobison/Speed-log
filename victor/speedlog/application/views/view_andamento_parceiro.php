    ...
    <div class="breadcrumbs">
      ...
      <nav>
        <div class="container">
          ...
          <li><a href="<?php echo base_url('index.php/home/solicitacoes') ?>">Solicitações de Entrega</a></li>
          <li>Entregas em Andamento</a></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
    ...
    <section id="service-details" class="service-details">
        <div class="container" data-aos="fade-up">
            ...
            <div class="rolag" id="pendentes">
                <div class="row gy-4"> 
                <?php foreach($dados as $informacoes=>$entrega){?>
                <div class="col">
                    <div class="card text-center mb-3" style="width: 18rem;"style="width: 18rem; background-color: white !important">
                        <div class="card-body">
                           <div style="width: 100%; border-bottom: 1px solid #000; border-top: 1px solid #000; padding: 10px; ">
                            ...
                            <img src="<?php echo base_url('assets/img/linha.png') ?>" style="height:60px !important; margin-left: -20px" alt=""> Viagem de  <?php echo $entrega->tempo?> - <?php echo $entrega->distancia?><p></p>
                            ...
                            <a href="<?php echo base_url('index.php/home/finalizar/'.$_SESSION['parceiro'][0]['ri_parceiro']."/".$entrega->cdg_envio)?>" class="btn btn-info"> Entrega finalizada </a>
                        </div>
                    </div>
                </div>
                <?php } ?>
